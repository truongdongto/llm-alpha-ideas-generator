WORLDQUANT_101_ALPHAS = [
    {
        ...
        "rationale": "Volatility-based indicator analyzing standard deviation of returns or price differences for Alpha#1."
    },
    {
        "theme": "volume",
        "expression": "(-1 * correlation(rank(delta(log(volume), 2)), rank(((close - open) / open)), 6))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#2."
    },
    {
        "theme": "volume",
        "expression": "(-1 * correlation(rank(open), rank(volume), 10))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#3."
    },
    {
        "theme": "momentum",
        "expression": "(-1 * Ts_Rank(rank(low), 9))",
        "rationale": "Alpha model predicting price trend based on historical trading features for Alpha#4."
    },
    {
        "theme": "trend",
        "expression": "(rank((open - (sum(vwap, 10) / 10))) * (-1 * abs(rank((close - vwap)))))",
        "rationale": "Trend indicator analyzing intraday price movement and open-to-close relations for Alpha#5."
    },
    {
        "theme": "volume",
        "expression": "(-1 * correlation(open, volume, 10))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#6."
    },
    {
        "theme": "volume",
        "expression": "((adv20 < volume) ? ((-1 * ts_rank(abs(delta(close, 7)), 60)) * sign(delta(close, 7))) : (-1 * 1))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#7."
    },
    {
        "theme": "momentum",
        "expression": "(-1 * rank(((sum(open, 5) * sum(returns, 5)) - delay((sum(open, 5) * sum(returns, 5)), 10))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#8."
    },
    {
        "theme": "momentum",
        "expression": "((0 < ts_min(delta(close, 1), 5)) ? delta(close, 1) : ((ts_max(delta(close, 1), 5) < 0) ? delta(close, 1) : (-1 * delta(close, 1))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#9."
    },
    {
        "theme": "momentum",
        "expression": "rank(((0 < ts_min(delta(close, 1), 4)) ? delta(close, 1) : ((ts_max(delta(close, 1), 4) < 0) ? delta(close, 1) : (-1 * delta(close, 1)))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#10."
    },
    {
        "theme": "volume",
        "expression": "((rank(ts_max((vwap - close), 3)) + rank(ts_min((vwap - close), 3))) * rank(delta(volume, 3)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#11."
    },
    {
        "theme": "volume",
        "expression": "(sign(delta(volume, 1)) * (-1 * delta(close, 1)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#12."
    },
    {
        "theme": "volume",
        "expression": "(-1 * rank(covariance(rank(close), rank(volume), 5)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#13."
    },
    {
        "theme": "volume",
        "expression": "((-1 * rank(delta(returns, 3))) * correlation(open, volume, 10))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#14."
    },
    {
        "theme": "volume",
        "expression": "(-1 * sum(rank(correlation(rank(high), rank(volume), 3)), 3))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#15."
    },
    {
        "theme": "volume",
        "expression": "(-1 * rank(covariance(rank(high), rank(volume), 5)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#16."
    },
    {
        "theme": "volume",
        "expression": "(((-1 * rank(ts_rank(close, 10))) * rank(delta(delta(close, 1), 1))) * rank(ts_rank((volume / adv20), 5)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#17."
    },
    {
        "theme": "volatility",
        "expression": "(-1 * rank(((stddev(abs((close - open)), 5) + (close - open)) + correlation(close, open, 10))))",
        "rationale": "Volatility-based indicator analyzing standard deviation of returns or price differences for Alpha#18."
    },
    {
        "theme": "momentum",
        "expression": "((-1 * sign(((close - delay(close, 7)) + delta(close, 7)))) * (1 + rank((1 + sum(returns, 250)))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#19."
    },
    {
        "theme": "trend",
        "expression": "(((-1 * rank((open - delay(high, 1)))) * rank((open - delay(close, 1)))) * rank((open - delay(low, 1))))",
        "rationale": "Trend indicator analyzing intraday price movement and open-to-close relations for Alpha#20."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#21."
    },
    {
        "theme": "volume",
        "expression": "(-1 * (delta(correlation(high, volume, 5), 5) * rank(stddev(close, 20))))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#22."
    },
    {
        "theme": "momentum",
        "expression": "(((sum(high, 20) / 20) < high) ? (-1 * delta(high, 2)) : 0)",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#23."
    },
    {
        "theme": "momentum",
        ...
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#24."
    },
    {
        "theme": "volume",
        "expression": "rank(((((-1 * returns) * adv20) * vwap) * (high - close)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#25."
    },
    {
        "theme": "volume",
        "expression": "(-1 * ts_max(correlation(ts_rank(volume, 5), ts_rank(high, 5), 5), 3))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#26."
    },
    {
        "theme": "volume",
        "expression": "((0.5 < rank((sum(correlation(rank(volume), rank(vwap), 6), 2) / 2.0))) ? (-1 * 1) : 1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#27."
    },
    {
        "theme": "volume",
        "expression": "scale(((correlation(adv20, low, 5) + ((high + low) / 2)) - close))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#28."
    },
    {
        "theme": "momentum",
        ...
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#29."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#30."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#31."
    },
    {
        "theme": "mean_reversion",
        "expression": "(scale(((sum(close, 7) / 7) - close)) + (20 * scale(correlation(vwap, delay(close, 5), 230))))",
        "rationale": "Mean reversion signal looking at correlation/covariance of prices or volume over time for Alpha#32."
    },
    {
        "theme": "trend",
        "expression": "rank((-1 * ((1 - (open / close))^1)))",
        "rationale": "Trend indicator analyzing intraday price movement and open-to-close relations for Alpha#33."
    },
    {
        "theme": "volatility",
        "expression": "rank(((1 - rank((stddev(returns, 2) / stddev(returns, 5)))) + (1 - rank(delta(close, 1)))))",
        "rationale": "Volatility-based indicator analyzing standard deviation of returns or price differences for Alpha#34."
    },
    {
        "theme": "volume",
        "expression": "((Ts_Rank(volume, 32) * (1 - Ts_Rank(((close + high) - low), 16))) * (1 - Ts_Rank(returns, 32)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#35."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#36."
    },
    {
        "theme": "mean_reversion",
        "expression": "(rank(correlation(delay((open - close), 1), close, 200)) + rank((open - close)))",
        "rationale": "Mean reversion signal looking at correlation/covariance of prices or volume over time for Alpha#37."
    },
    {
        "theme": "trend",
        "expression": "((-1 * rank(Ts_Rank(close, 10))) * rank((close / open)))",
        "rationale": "Trend indicator analyzing intraday price movement and open-to-close relations for Alpha#38."
    },
    {
        "theme": "volume",
        "expression": "((-1 * rank((delta(close, 7) * (1 - rank(decay_linear((volume / adv20), 9)))))) * (1 + rank(sum(returns, 250))))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#39."
    },
    {
        "theme": "volume",
        "expression": "((-1 * rank(stddev(high, 10))) * correlation(high, volume, 10))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#40."
    },
    {
        "theme": "momentum",
        "expression": "(((high * low)^0.5) - vwap)",
        "rationale": "Alpha model predicting price trend based on historical trading features for Alpha#41."
    },
    {
        "theme": "momentum",
        "expression": "(rank((vwap - close)) / rank((vwap + close)))",
        "rationale": "Alpha model predicting price trend based on historical trading features for Alpha#42."
    },
    {
        "theme": "volume",
        "expression": "(ts_rank((volume / adv20), 20) * ts_rank((-1 * delta(close, 7)), 8))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#43."
    },
    {
        "theme": "volume",
        "expression": "(-1 * correlation(high, rank(volume), 5))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#44."
    },
    {
        "theme": "volume",
        "expression": "(-1 * ((rank((sum(delay(close, 5), 20) / 20)) * correlation(close, volume, 2)) * rank(correlation(sum(close, 5), sum(close, 20), 2))))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#45."
    },
    {
        "theme": "momentum",
        ...
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#46."
    },
    {
        "theme": "volume",
        "expression": "((((rank((1 / close)) * volume) / adv20) * ((high * rank((high - close))) / (sum(high, 5) / 5))) - rank((vwap - delay(vwap, 5))))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#47."
    },
    {
        "theme": "mean_reversion",
        ...
        "rationale": "Mean reversion signal looking at correlation/covariance of prices or volume over time for Alpha#48."
    },
    {
        "theme": "momentum",
        "expression": "(((((delay(close, 20) - delay(close, 10)) / 10) - ((delay(close, 10) - close) / 10)) < (-1 * 0.1)) ? 1 : ((-1 * 1) * (close - delay(close, 1))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#49."
    },
    {
        "theme": "volume",
        "expression": "(-1 * ts_max(rank(correlation(rank(volume), rank(vwap), 5)), 5))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#50."
    },
    {
        "theme": "momentum",
        "expression": "(((((delay(close, 20) - delay(close, 10)) / 10) - ((delay(close, 10) - close) / 10)) < (-1 * 0.05)) ? 1 : ((-1 * 1) * (close - delay(close, 1))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#51."
    },
    {
        "theme": "volume",
        "expression": "((((-1 * ts_min(low, 5)) + delay(ts_min(low, 5), 5)) * rank(((sum(returns, 240) - sum(returns, 20)) / 220))) * ts_rank(volume, 5))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#52."
    },
    {
        "theme": "momentum",
        "expression": "(-1 * delta((((close - low) - (high - close)) / (close - low)), 9))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#53."
    },
    {
        "theme": "trend",
        "expression": "((-1 * ((low - close) * (open^5))) / ((low - high) * (close^5)))",
        "rationale": "Trend indicator analyzing intraday price movement and open-to-close relations for Alpha#54."
    },
    {
        "theme": "volume",
        "expression": "(-1 * correlation(rank(((close - ts_min(low, 12)) / (ts_max(high, 12) - ts_min(low, 12)))), rank(volume), 6))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#55."
    },
    {
        "theme": "momentum",
        "expression": "(0 - (1 * (rank((sum(returns, 10) / sum(sum(returns, 2), 3))) * rank((returns * cap)))))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#56."
    },
    {
        "theme": "momentum",
        "expression": "(0 - (1 * ((close - vwap) / decay_linear(rank(ts_argmax(close, 30)), 2))))",
        "rationale": "Alpha model predicting price trend based on historical trading features for Alpha#57."
    },
    {
        "theme": "volume",
        "expression": "(-1 * Ts_Rank(decay_linear(correlation(IndNeutralize(vwap, IndClass.sector), volume, 3.92795), 7.89291), 5.50322))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#58."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#59."
    },
    {
        "theme": "volume",
        "expression": "(0 - (1 * ((2 * scale(rank(((((close - low) - (high - close)) / (high - low)) * volume)))) - scale(rank(ts_argmax(close, 10))))))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#60."
    },
    {
        "theme": "volume",
        "expression": "(rank((vwap - ts_min(vwap, 16.1219))) < rank(correlation(vwap, adv180, 17.9282)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#61."
    },
    {
        "theme": "volume",
        "expression": "((rank(correlation(vwap, sum(adv20, 22.4101), 9.91009)) < rank(((rank(open) + rank(open)) < (rank(((high + low) / 2)) + rank(high))))) * -1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#62."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#63."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#64."
    },
    {
        "theme": "volume",
        "expression": "((rank(correlation(((open * 0.00817205) + (vwap * (1 - 0.00817205))), sum(adv60, 8.6911), 6.40374)) < rank((open - ts_min(open, 13.635)))) * -1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#65."
    },
    {
        "theme": "momentum",
        ...
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#66."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#67."
    },
    {
        "theme": "volume",
        "expression": "((Ts_Rank(correlation(rank(high), rank(adv15), 8.91644), 13.9333) < rank(delta(((close * 0.518371) + (low * (1 - 0.518371))), 1.06157))) * -1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#68."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#69."
    },
    {
        "theme": "volume",
        "expression": "((rank(delta(vwap, 1.29456))^Ts_Rank(correlation(IndNeutralize(close, IndClass.industry), adv50, 17.8256), 17.9171)) * -1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#70."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#71."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#72."
    },
    {
        "theme": "momentum",
        ...
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#73."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#74."
    },
    {
        "theme": "volume",
        "expression": "(rank(correlation(vwap, volume, 4.24304)) < rank(correlation(rank(low), rank(adv50), 12.4413)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#75."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#76."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#77."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#78."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#79."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#80."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#81."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#82."
    },
    {
        "theme": "volume",
        "expression": "((rank(delay(((high - low) / (sum(close, 5) / 5)), 2)) * rank(rank(volume))) / (((high - low) / (sum(close, 5) / 5)) / (vwap - close)))",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#83."
    },
    {
        "theme": "momentum",
        "expression": "SignedPower(Ts_Rank((vwap - ts_max(vwap, 15.3217)), 20.7127), delta(close, 4.96796))",
        "rationale": "Momentum indicator analyzing price changes, returns, or lagged historical dynamics for Alpha#84."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#85."
    },
    {
        "theme": "volume",
        "expression": "((Ts_Rank(correlation(close, sum(adv20, 14.7444), 6.00049), 20.4195) < rank(((open + close) - (vwap + open)))) * -1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#86."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#87."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#88."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#89."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#90."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#91."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#92."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#93."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#94."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#95."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#96."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#97."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#98."
    },
    {
        "theme": "volume",
        "expression": "((rank(correlation(sum(((high + low) / 2), 19.8975), sum(adv60, 19.8975), 8.8136)) < rank(correlation(low, volume, 6.28259))) * -1)",
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#99."
    },
    {
        "theme": "volume",
        ...
        "rationale": "Volume-based indicator seeking to capture liquidity and trading intensity dynamics for Alpha#100."
    },
    {
        "theme": "trend",
        "expression": "((close - open) / ((high - low) + .001))",
        "rationale": "Trend indicator analyzing intraday price movement and open-to-close relations for Alpha#101."
    },
]

THEMES = sorted(set(item['theme'] for item in WORLDQUANT_101_ALPHAS))
